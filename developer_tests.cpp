...
bool createAVL()
{
    ...
    std::shared_ptr<Player> player1(new Player(4, 2, 5, 6, 4, false)); // id: 4
    std::shared_ptr<Player> player2(new Player(1, 2, 3, 3, 4, false)); // id: 1
    std::shared_ptr<Player> player3(new Player(7, 2, 3, 3, 4, false)); // id: 7
    std::shared_ptr<Player> player4(new Player(3, 2, 3, 3, 4, false)); // id: 3
    tree1.add(player1);
...
{
    AVL_tree<Player> tree1(false); // sort by ID
    std::shared_ptr<Player> player1(new Player(8, 2, 5, 6, 4, false)); // id: 8
    std::shared_ptr<Player> player2(new Player(5, 2, 3, 3, 4, false)); // id: 5
    std::shared_ptr<Player> player3(new Player(3, 2, 3, 3, 4, false)); // id: 3
    std::shared_ptr<Player> player4(new Player(2, 2, 3, 3, 4, false)); // id: 2
    std::shared_ptr<Player> player5(new Player(1, 2, 3, 3, 4, false)); // id: 1
    tree1.add(player1);
    tree1.add(player2);
    tree1.add(player3);
    tree1.add(player4);
...
{
    AVL_tree<Player> tree1(false); // sort by ID
    std::shared_ptr<Player> player1(new Player(1, 2, 5, 6, 4, false)); // id: 1
    std::shared_ptr<Player> player2(new Player(2, 2, 5, 6, 4, false)); // id: 2
    std::shared_ptr<Player> player3(new Player(3, 2, 3, 3, 4, false)); // id: 3
    std::shared_ptr<Player> player4(new Player(4, 2, 3, 3, 4, false)); // id: 4
    std::shared_ptr<Player> player5(new Player(5, 2, 3, 3, 4, false)); // id: 5
    std::shared_ptr<Player> player6(new Player(6, 2, 3, 3, 4, false)); // id: 6
    std::shared_ptr<Player> player7(new Player(7, 2, 3, 3, 4, false)); // id: 7
    tree1.add(player1);
    tree1.add(player2);
    tree1.add(player3);
    tree1.add(player4);
...
bool balanceAVL_LR()
{
    ...
    std::shared_ptr<Player> player6(new Player(6, 2, 3, 3, 4, false)); // id: 6
    std::shared_ptr<Player> player7(new Player(7, 2, 3, 3, 4, false)); // id: 7
    std::shared_ptr<Player> player8(new Player(8, 2, 3, 3, 4, false)); // id: 8
    std::shared_ptr<Player> player10(new Player(10, 2, 3, 3, 4, false)); // id: 10
    std::shared_ptr<Player> player20(new Player(20, 2, 3, 3, 4, false)); // id: 20
    std::shared_ptr<Player> player21(new Player(21, 2, 3, 3, 4, false)); // id: 21
    tree1.add(player10);
    tree1.add(player4);
    tree1.add(player20);
    tree1.add(player21);
...
{
    AVL_tree<Player> tree1(false); // sort by ID
    std::shared_ptr<Player>player10(new Player (10, 2, 3, 3, 4, false));
    std::shared_ptr<Player>player5(new Player (5, 2, 3, 3, 4, false));
    std::shared_ptr<Player>player20(new Player (20, 2, 3, 3, 4, false));
    std::shared_ptr<Player>player4(new Player (4, 2, 3, 3, 4, false));
    std::shared_ptr<Player>player6(new Player (6, 2, 3, 3, 4, false));
    std::shared_ptr<Player>player15(new Player (15, 2, 3, 3, 4, false));
    std::shared_ptr<Player>player30(new Player (30, 2, 3, 3, 4, false));
    std::shared_ptr<Player>player12(new Player (12, 2, 3, 3, 4, false));
    std::shared_ptr<Player>player18(new Player (18, 2, 3, 3, 4, false));
    std::shared_ptr<Player>player25(new Player (25, 2, 3, 3, 4, false));
    std::shared_ptr<Player>player40(new Player (40, 2, 3, 3, 4, false));
    //
    std::shared_ptr<Player>player19(new Player (19, 2, 3, 3, 4, false));
    //
    tree1.add(player10);
    tree1.add(player5);
    tree1.add(player20);
...
//    << AVL_testing<Player>::run_tests_on_worldCup(&worldCup);
//
//    worldCup.add_player(33, 2, 5, 6, 0, true); // ERROR CODE //TODO: fix segfault
