...
bool Team::remove_player(int player_id)
{
    ...
    return success;
    // TODO: top_scorer mechanism when you have remove. possibly use inorder_traversal() for that, since we just need O(n), not log.
}
...
{
    //TODO: make sure int is right return type.
