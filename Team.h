...
public:
    ...
    void compare_to_top_scorer(const Player &sharedPtr);


    // PRINTING AND DEBUGGING
    friend std::ostream& operator<<(std::ostream& os, const Team& team);
    AVL_tree<Player>* get_AVL_tree_id(); // a pointer to an AVL tree of player nodes
    AVL_tree<Player>* get_AVL_tree_score(); // a pointer to an AVL tree of player nodes
...
private:
    ...
    int gamesPlayed;
    Player* top_scorer; //should get updated when a player is added or removed
