...
OBJS=$(O_FILES_DIR)/UnitTests.o $(O_FILES_DIR)/NodeList.o $(O_FILES_DIR)/Team.o $(O_FILES_DIR)/Player.o $(O_FILES_DIR)/worldcup23a1.o # UPDATE HERE ALL THE O FILES YOU CREATED BELOW
...
#$(O_FILES_DIR)/AVL_tree.o : AVL_tree.h NodeList.h
#	@mkdir -p $(O_FILES_DIR)
#	$(GPP) -c $(COMP_FLAG) AVL_tree.cpp -o $@

#nodelist
$(O_FILES_DIR)/NodeList.o : NodeList.cpp NodeList.h
	@mkdir -p $(O_FILES_DIR)
	$(GPP) -c $(COMP_FLAG) NodeList.cpp -o $@
...
#$(O_FILES_DIR)/developer_tests.o : developer_tests.cpp developer_tests.h worldcup23a1.h wet1util.h AVL_tree.h NodeList.h Exception.h Team.h Player.h
#	@mkdir -p $(O_FILES_DIR)
